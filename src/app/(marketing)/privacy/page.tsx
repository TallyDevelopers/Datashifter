  ...
  return (
    <div className="mx-auto max-w-3xl px-6 py-24 lg:px-8">
      ...
      <div className="mt-10 space-y-8 text-sm leading-relaxed text-muted-foreground [&_h2]:text-base [&_h2]:font-semibold [&_h2]:text-foreground [&_h2]:mt-8 [&_h2]:mb-3">
        <p>
          SwiftPort (&ldquo;we,&rdquo; &ldquo;us,&rdquo; or &ldquo;our&rdquo;) is committed to protecting your privacy. This Privacy Policy explains how we collect, use, and protect information when you use our platform.
        </p>
        ...
        <p>
          <strong className="text-foreground">We do not store your Salesforce record data.</strong> SwiftPort processes records in-memory during a sync and does not persist the values of Salesforce records. We store only metadata: record IDs, sync configurations, execution logs, and error messages.
        </p>
        ...
        <ul className="list-disc pl-5 space-y-1.5 mt-2">
          <li>Provide, operate, and improve the SwiftPort service</li>
